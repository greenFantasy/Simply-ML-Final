import { AggregateOp, Align, Color, Compare as VgCompare, ExprRef as VgExprRef, Field as VgField, FlattenTransform as VgFlattenTransform, FoldTransform as VgFoldTransform, FontStyle as VgFontStyle, FontWeight as VgFontWeight, KDETransform as VgKDETransform, LayoutAlign, LoessTransform as VgLoessTransform, Orientation, ProjectionType, QuantileTransform as VgQuantileTransform, RegressionTransform as VgRegressionTransform, SampleTransform as VgSampleTransform, SignalRef, SortField as VgSortField, TextBaseline as VgTextBaseline, Title as VgTitle, UnionSortField as VgUnionSortField, ScaledValueRef, NumericValueRef, ColorValueRef } from 'vega';
...
export declare type VgTransform = VgBinTransform | VgExtentTransform | VgFormulaTransform | VgAggregateTransform | VgFilterTransform | VgFlattenTransform | VgImputeTransform | VgStackTransform | VgCollectTransform | VgLookupTransform | VgIdentifierTransform | VgGeoPointTransform | VgGeoJSONTransform | VgGraticuleTransform | VgWindowTransform | VgJoinAggregateTransform | VgFoldTransform | VgSampleTransform | VgSequenceTransform | VgKDETransform | VgLoessTransform | VgQuantileTransform | VgRegressionTransform | VgPivotTransform;
