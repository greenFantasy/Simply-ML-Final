 ...
 */
export declare type ChannelDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradient = Value> = FieldDefWithCondition<F, V> | ValueDefWithCondition<F, V>;
/**
 ...
 * @minProperties 1
 */
export declare type ValueDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradient = Value> = Partial<ValueDef<V>> & {
    /**
 ...
 * }
 */
export declare type FieldDefWithCondition<F extends FieldDef<any>, V extends ValueOrGradient = Value> = F & ConditionValueDefMixins<V>;
...
export declare type ChannelDef<FD extends FieldDef<any> = FieldDef<string>, V extends ValueOrGradient = ValueOrGradient> = ChannelDefWithCondition<FD, V>;
export declare function isConditionalDef<F extends Field, V extends ValueOrGradient>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is ChannelDefWithCondition<FieldDef<F>, V>;
/**
 * Return if a channelDef is a ConditionalValueDef with ConditionFieldDef
 */
export declare function hasConditionalFieldDef<F extends Field, V extends ValueOrGradient>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is Partial<ValueDef<V>> & {
...
export declare function isValueDef<F extends Field, V extends ValueOrGradient>(channelDef: ChannelDef<FieldDef<F>, V>): channelDef is ValueDef<V>;
