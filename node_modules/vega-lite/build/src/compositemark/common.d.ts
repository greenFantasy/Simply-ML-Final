...
export declare function getTitle(continuousAxisChannelDef: PositionFieldDef<string>): string;
...
}) => GenericUnitSpec<Encoding<Field>, "circle" | "square" | "area" | "image" | "line" | "rect" | "rule" | "text" | "trail" | "point" | "geoshape" | "bar" | "tick" | MarkDef<Mark>>[];
